...
// Public interface
export function comp<T>(fn: (v: T | undefined) => T, value?: T): () => T {
...
export function effect<T>(fn: (v: T | undefined) => T, value?: T): void {
...
export function makeDataNode(value: any) {
...
export function disposeNode(node: ComputationNode) {
  if (RunningClock !== null) {
